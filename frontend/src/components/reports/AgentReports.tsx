          ...
          <div className="relative bg-slate-800 rounded-2xl p-8 w-full max-w-4xl max-h-[90vh] overflow-y-auto border border-white/10">
            ...
            <div className="bg-slate-900/50 rounded-xl p-6 mb-8">
              <div className="text-center">
                <p className="text-gray-400 text-sm mb-2">Overall Performance Score</p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              <div className="bg-slate-900/50 rounded-xl p-4">
                <p className="text-gray-400 text-sm mb-1">Avg Duration</p>
                <p className="text-3xl font-bold text-white">
                  {Math.floor(selectedReport.avgDuration / 60)}:
                  {String(selectedReport.avgDuration % 60).padStart(2, "0")}
                </p>
              </div>
            </div>

            {/* Skills Breakdown */}
            {selectedReport.topSkills && (
              <div className="bg-slate-900/50 rounded-xl p-6 mb-8">
                ...
                <ResponsiveContainer width="100%" height={250}>
                  <BarChart data={selectedReport.topSkills}>
